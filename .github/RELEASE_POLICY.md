...
Release Please maintains one release pull request from conventional commits. Merging that pull request updates package.json and CHANGELOG.md, creates the matching vX.Y.Z tag, and publishes the GitHub Release. It does not publish an npm package or container image.
